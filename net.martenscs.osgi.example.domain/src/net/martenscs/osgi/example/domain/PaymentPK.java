...
import net.martenscs.osgi.example.domain.api.PayPK;
 ...
 */
@Embeddable
public class PaymentPK implements Serializable, PayPK {
	...
	public boolean equals(Object other) {
		...
		return (this.customernumber == castOther.customernumber)
